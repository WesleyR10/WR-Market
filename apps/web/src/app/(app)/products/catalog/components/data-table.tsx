        ...
        <div className="ml-auto flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() =>
                  table.getColumn('totalBuyers')?.toggleSorting(false)
                }
              >
                Ordenar por Total de Compradores
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              <DropdownMenuItem
                onClick={() => table.getColumn('stock')?.toggleSorting(false)}
              >
                Ordenar por Estoque
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => table.getColumn('rating')?.toggleSorting(false)}
              >
