...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-emerald-200/50 p-1 text-emerald-900',
      className,
    )}
    {...props}
  />
